...
class Generator: 
    ...
    @classmethod
    def get_PMT_signal(cls, num_photoelectrons, T, t_0, Tao_fall_nano, Tao_rise_nano, Tao_fall_spe_nano, Tao_rise_spe_nano):
        ...
        expected = cls.get_double_exponential(num_photoelectrons, T, t_0, Tao_fall_nano, Tao_rise_nano)
        ...
        for i in range(len(arrival_noise)):
            ...
            for j in range(arrival_noise[i]):
                ...
                t_j = T[i]
                signal += cls.get_double_exponential(A_j, T, t_j , Tao_fall_spe_nano, Tao_rise_spe_nano)
